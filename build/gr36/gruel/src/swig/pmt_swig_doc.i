...
%feature("docstring") gruel::msg_accepter::post "send  to  on port
...
%feature("docstring") pmt::pmt_comperator "Provide a comparator function object to allow pmt use in stl types."
