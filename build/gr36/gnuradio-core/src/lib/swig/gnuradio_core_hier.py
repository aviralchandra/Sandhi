...
class gr_channel_model_sptr(object):
    ...
    def to_element(self, *args):
        ...
        to_element(self) -> Element
        """
        return _gnuradio_core_hier.gr_channel_model_sptr_to_element(self, *args)

    def equals(self, *args, **kwargs):
        """equals(self, Element rhs) -> bool"""
        return _gnuradio_core_hier.gr_channel_model_sptr_equals(self, *args, **kwargs)

    def to_string(self):
        """to_string(self) -> string"""
        return _gnuradio_core_hier.gr_channel_model_sptr_to_string(self)
    ...
    def global_config(self, *args):
        ...
        global_config(self) -> GlobalBlockConfig
        """
        return _gnuradio_core_hier.gr_channel_model_sptr_global_config(self, *args)

    def commit_config(self):
        """commit_config(self)"""
        return _gnuradio_core_hier.gr_channel_model_sptr_commit_config(self)

    def set_uid(self, *args, **kwargs):
        """set_uid(self, string uid)"""
        return _gnuradio_core_hier.gr_channel_model_sptr_set_uid(self, *args, **kwargs)

    def get_uid(self):
        """get_uid(self) -> string"""
        return _gnuradio_core_hier.gr_channel_model_sptr_get_uid(self)

    def adopt_element(self, *args, **kwargs):
        """adopt_element(self, string name, Element child)"""
        return _gnuradio_core_hier.gr_channel_model_sptr_adopt_element(self, *args, **kwargs)

    def locate_element(self, *args, **kwargs):
        """locate_element(self, string path) -> Element"""
        return _gnuradio_core_hier.gr_channel_model_sptr_locate_element(self, *args, **kwargs)

    def get_registered_names(self):
        """get_registered_names(self) -> std::vector<(std::string,std::allocator<(std::string)>)>"""
        return _gnuradio_core_hier.gr_channel_model_sptr_get_registered_names(self)

    def _handle_call(self, *args, **kwargs):
        """_handle_call(self, string arg0, PMCC arg1) -> PMCC"""
        return _gnuradio_core_hier.gr_channel_model_sptr__handle_call(self, *args, **kwargs)
