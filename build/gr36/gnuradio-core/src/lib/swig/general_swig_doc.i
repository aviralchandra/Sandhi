...
%feature("docstring") gr_annotator_raw "raw stream annotator testing block.
...
%feature("docstring") gr_make_annotator_raw "raw stream annotator testing block.
...
%feature("docstring") gr_block_gateway "The gateway block which performs all the magic.
...
%feature("docstring") gr_block_gateway::gr_block_message "Provide access to the shared message object."
...
%feature("docstring") gr_make_block_gateway "The gateway block which performs all the magic.
...
%feature("docstring") gr_endian_swap "Convert stream of items into thier byte swapped version.
...
%feature("docstring") gr_make_endian_swap "Convert stream of items into thier byte swapped version.
...
%feature("docstring") gr_message_strobe "Send message at defined interval."
...
%feature("docstring") gr_make_message_strobe "Send message at defined interval."
...
%feature("docstring") gr_random_pdu "Send message at defined interval."
...
%feature("docstring") gr_make_random_pdu "Send message at defined interval."
...
%feature("docstring") gr_tag_debug "Bit bucket that prints out any tag received.
...
%feature("docstring") gr_tag_debug::current_tags "Returns a vector of gr_tag_t items as of the last call to work."

%feature("docstring") gr_tag_debug::set_display "Set the display of tags to stdout on/off."



%feature("docstring") gr_make_tag_debug "Bit bucket that prints out any tag received.
...
%feature("docstring") gr_feval_p "base class for evaluating a function: pmt -> void

This class is designed to be subclassed in Python or C++ and is callable from both places. It uses SWIG's \"director\" feature to implement the magic. It's slow. Don't use it in a performance critical path.

Override eval to define the behavior. Use calleval to invoke eval (this kludge is required to allow a python specific \"shim\" to be inserted."

%feature("docstring") gr_feval_p::eval "override this to define the function"
...
%feature("docstring") gri_control_loop::set_frequency "Set the control loop's frequency.
...
%feature("docstring") gri_control_loop::set_phase "Set the control loop's phase.
...
%feature("docstring") gri_control_loop::set_max_freq "Set the control loop's maximum frequency.

Set the maximum frequency the control loop can track."

%feature("docstring") gri_control_loop::set_min_freq "Set the control loop's minimum frequency.
...
%feature("docstring") gri_control_loop::get_frequency "Get the control loop's frequency estimate."

%feature("docstring") gri_control_loop::get_phase "Get the control loop's phase estimate."

%feature("docstring") gri_control_loop::get_max_freq "Get the control loop's maximum frequency."

%feature("docstring") gri_control_loop::get_min_freq "Get the control loop's minimum frequency."
