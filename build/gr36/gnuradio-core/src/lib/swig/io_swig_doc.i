...
%feature("docstring") gr_file_source::open "Opens a new file."

%feature("docstring") gr_file_source::close "Close the file handle."
...
%feature("docstring") gr_message_burst_source "Turn received messages into a stream and tag them for UHD to send."
...
%feature("docstring") gr_make_message_burst_source "Turn received messages into a stream and tag them for UHD to send."

%feature("docstring") gr_message_debug "Print received messages to stdout."

%feature("docstring") gr_message_debug::print "Messages received in this port are printed to stdout.

This port receives messages from the scheduler's message handling mechanism and prints it to stdout. This message handler function is only meant to be used by the scheduler to handle messages posted to port 'print'."

%feature("docstring") gr_message_debug::print_pdu "PDU formatted messages received in this port are printed to stdout.

This port receives messages from the scheduler's message handling mechanism and prints it to stdout. This message handler function is only meant to be used by the scheduler to handle messages posted to port 'print'."

%feature("docstring") gr_message_debug::store "Messages received in this port are stored in a vector.

This port receives messages from the scheduler's message handling mechanism and stores it in a vector. Messages can be retrieved later using the 'get_message' function. This message handler function is only meant to be used by the scheduler to handle messages posted to port 'store'."





%feature("docstring") gr_message_debug::num_messages "Reports the number of messages received by this block."

%feature("docstring") gr_message_debug::get_message "Get a message (as a PMT) from the message vector at index .
...
%feature("docstring") gr_make_message_debug "Print received messages to stdout."
...
%feature("docstring") gr_pdu_to_tagged_stream "Turn received messages into a stream."
...
%feature("docstring") gr_make_pdu_to_tagged_stream "Turn received messages into a stream."

%feature("docstring") gr_socket_pdu "Gather received items into messages and insert into msgq."
...
%feature("docstring") gr_make_socket_pdu "Gather received items into messages and insert into msgq."
...
%feature("docstring") gr_tagged_stream_to_pdu "Turn received messages into a stream."
...
%feature("docstring") gr_make_tagged_stream_to_pdu "Turn received messages into a stream."
...
%feature("docstring") gr_stream_pdu_base "Gather received items into messages and insert into msgq."
