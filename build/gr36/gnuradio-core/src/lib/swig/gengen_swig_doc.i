...
%feature("docstring") gr_add_const_bb "output = input + constant"
...
%feature("docstring") gr_make_add_const_bb "output = input + constant"
...
%feature("docstring") gr_fastnoise_source_c "Random number source.
...
%feature("docstring") gr_make_fastnoise_source_c "Random number source.
...
%feature("docstring") gr_fastnoise_source_f "Random number source.
...
%feature("docstring") gr_make_fastnoise_source_f "Random number source.
...
%feature("docstring") gr_fastnoise_source_i "Random number source.
...
%feature("docstring") gr_make_fastnoise_source_i "Random number source.
...
%feature("docstring") gr_fastnoise_source_s "Random number source.
...
%feature("docstring") gr_make_fastnoise_source_s "Random number source.
