...
__load_modules_from_paths(os.getenv("GRAS_ROOT", "/usr/local"), os.path.join("lib", "gras", "python"))
__load_modules_from_paths(os.getenv("GRAS_PATH", ""), os.path.join("lib", "gras", "python"))
